...
// Promise.resolve('Ressolved promise 1').then(res => console.log(res));

// Promise.resolve('Revolved promise2').then(res => {
...
//     return wait(1);
//   })
//   .then(() => console.log('I waited for 1 sec'));s
